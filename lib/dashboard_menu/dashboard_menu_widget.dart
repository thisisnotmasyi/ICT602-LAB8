...
export 'dashboard_menu_model.dart';

class DashboardMenuWidget extends StatefulWidget {
  const DashboardMenuWidget({Key? key}) : super(key: key);

  @override
  _DashboardMenuWidgetState createState() => _DashboardMenuWidgetState();
}

class _DashboardMenuWidgetState extends State<DashboardMenuWidget>
    with TickerProviderStateMixin {
  late DashboardMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardMenuModel());
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 4.0, 0.0, 0.0),
                                        child: Text(
                                          'Click the icon to access microphone',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium,
                                        ).animateOnPageLoad(animationsMap[
